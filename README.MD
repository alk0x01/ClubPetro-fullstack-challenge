...
#### Navegue usando seu terminal ate a pasta do projeto e execute o comando `yarn` na pasta backend e com outro terminal execute o mesmo comando na pasta frontend
